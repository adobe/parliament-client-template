...
const Footer = () => (
  <>
    ...
    />
    <div class="udp footerr aem-GridColumn aem-GridColumn--default--12 footer">
      <footer class="udpFooter">
        <div class="grid-container">
          <div class="footer-content">
            <ul class="footer-columns">
              <li class="footer-column">
                <a href="javascript:void(0);" class="bloc-header">
                  APIs
                </a>
                <div class="bloc-content">
                  <ul class="bloc-elements">
                    <li class="bloc-element">
                      <a
                        class="footer-link"
              ...
              <li class="footer-column social-column">
                <a class="bloc-header" href="javascript:void(0);">
                  Blogs and Community
                </a>
                <div class="bloc-content">
                  <ul class="bloc-elements bloc-social">
                    <li class="bloc-element">
                      <a
                        class="footer-link"
                    ...
                    <li class="bloc-element">
                      <a class="footer-link" href="https://github.com/adobe">
                        Adobe on Github
                      </a>
                    </li>
                    <li class="bloc-element">
                      <a class="footer-link" href="https://twitter.com/AdobeIO">
